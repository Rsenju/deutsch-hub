...
-- =========================================================
-- has_role helper (security definer to prevent RLS recursion)
-- =========================================================
...
-- =========================================================
-- CONTENT: chapters, lessons, vocab, flashcards, exercises
-- =========================================================
...
CREATE INDEX flashcards_level_idx ON public.flashcards(level);
...
CREATE INDEX exercises_lesson_idx ON public.exercises(lesson_slug);
...
CREATE TABLE public.user_vocab_srs (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
...
CREATE INDEX uvs_due_idx ON public.user_vocab_srs(user_id, due_at);
...
CREATE POLICY "xp self insert" ON public.xp_events FOR INSERT TO authenticated WITH CHECK (auth.uid() = user_id);
